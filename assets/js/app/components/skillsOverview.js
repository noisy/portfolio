  ...
  template: `
    <section class="skills-section section py-5">
        <div class="container">
            ...
            <div class="section-intro mx-auto text-center mb-5 text-secondary">I have more than 12 years' experience
                building rich web applications & sophisticated applications for clients all over the world. Below is
                a
                quick overview of my main technical skill sets and tools I use. Want to find out more about my
                experience? <a class="text-link" href="resume.html">Check out my online resume</a>.</div>
                ...
                <div class="row">
                    <div class="skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0">
                        <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                            ...
                            <ul class="skills-list list-unstyled text-secondary">
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Vue.js/Angular/React
                                </li>
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Javascript/Typescript
                                </li>
                    ...
                    <div class="skills-block col-12 col-lg-4 mb-5 mb-3 mb-lg-0">
                        <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                            ...
                            <div
                                class="skills-icon-holder position-absolute d-inline-block rounded-circle text-center">
                                <img class="skills-icon" src="assets/images/backend-icon.png" style="margin: -5px;">
                            </div>
                            <ul class="skills-list list-unstyled text-secondary">
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Python/Django</li>
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>C/C++</li>
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Java</li>
                    ...
                    <div class="skills-block col-12 col-lg-4">
                        <div class="skills-block-inner bg-white shadow-sm py-4 px-5 position-relative">
                            ...
                            <ul class="skills-list list-unstyled text-secondary">
                                ...
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Docker</li>
                                <li class="mb-2"><i class="fas fa-check me-2 text-primary"></i>Stripe</li>
                            </ul>
                        </div>
                        <!--//skills-block-inner-->
                    </div>
