        ...
        <div class="container">
            ...
            <div class="press-logos row">
                <div
                    ...
                    <a class="logo-link" href="https://spidersweb.pl/2014/01/spistresci-pl.html" target="_blank">
                        <img class="img-fluid svg-ie-fix mt-3" src="/assets/images/logos/spidersweb.svg">
                    </a>
                </div>
                <div
                    class="align-self-center press-logo px-4 px-lg-4 col-8 col-sm-4 px-md-5 px-lg-5 m-4 mb-lg-0 mx-auto">
                    <a class="logo-link" href="https://niebezpiecznik.pl/post/white-hat-hacking-w-praktyce-czyli-jak-przejalem-11-kont-i-kontrole-nad-21-tysiacami-dolarow-w-kryptowalucie/" target="_blank">
                        <img class="img-fluid svg-ie-fix w-100" src="/assets/images/logos/niebezpiecznik.png"></a></div>
                <div
                    class="align-self-center press-logo px-4 px-lg-4 col-8 col-sm-4 px-md-5 px-lg-5 m-4 mb-lg-0 mx-auto">
